...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = KEYMAP(LT(3,KC_ESCAPE),KC_1,KC_2,KC_3,KC_4,KC_5,KC_6,KC_TAB,KC_Q,KC_W,KC_E,KC_R,KC_T,KC_LEFT,LSFT(KC_LCTL),KC_A,KC_S,KC_D,KC_F,KC_G,KC_LSHIFT,KC_Z,KC_X,KC_C,KC_V,KC_B,KC_RIGHT,LALT(KC_LSHIFT),KC_BSLASH,KC_LPRN,KC_RPRN,OSL(1),KC_LALT,TG(1),MEH_T(KC_NO),GUI_T(KC_SPACE),KC_LCTL,LSFT(KC_LGUI),KC_DELETE,KC_7,KC_8,KC_9,KC_0,KC_MINUS,LT(3,KC_EQUAL),KC_UP,KC_Y,KC_U,KC_I,KC_O,KC_P,KC_BSPACE,KC_H,KC_J,KC_K,KC_L,LT(2,KC_SCOLON),KC_ENTER,KC_DOWN,KC_N,KC_M,KC_COMMA,KC_DOT,KC_QUOTE,KC_LSHIFT,OSL(2),KC_LBRACKET,KC_RBRACKET,KC_SLASH,MO(1),TG(2),ALT_T(KC_APPLICATION),KC_HOME,KC_END,KC_LCTL,KC_SPACE),
  ...
  [3] = KEYMAP(KC_TRANSPARENT,LSFT(KC_F1),LSFT(KC_F2),LSFT(KC_F3),LSFT(KC_F4),LSFT(KC_F5),LSFT(KC_F6),LCTL(KC_TAB),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LCTL(LSFT(KC_TAB)),LCTL(KC_A),LCTL(KC_S),LCTL(KC_D),LCTL(KC_F),LCTL(KC_G),KC_TRANSPARENT,LCTL(KC_Z),LCTL(KC_X),LCTL(KC_C),LCTL(KC_V),LCTL(KC_B),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LSFT(KC_F7),LSFT(KC_F8),LSFT(KC_F9),LSFT(KC_F10),LSFT(KC_F11),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LSFT(KC_F12),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LALT(LGUI(KC_L)),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,LCTL(KC_N),KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_QUES,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT,KC_TRANSPARENT),
